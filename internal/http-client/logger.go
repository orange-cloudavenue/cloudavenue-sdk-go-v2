...
func (l *restyLogger) Debugf(msg string, keysAndValues ...any) {
	l.s.Debug(msg, keysAndValues...)
}

func (l *restyLogger) Warnf(msg string, keysAndValues ...any) {
	l.s.Warn(msg, keysAndValues...)
}

func (l *restyLogger) Errorf(msg string, keysAndValues ...any) {
