...
func (c *Client) AddVdc(ctx context.Context, params types.ParamsAddVdcToVdcGroup) error {
...
func (c *Client) RemoveVdc(ctx context.Context, params types.ParamsRemoveVdcFromVdcGroup) error {
