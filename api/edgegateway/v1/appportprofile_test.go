...
func TestCreateAppPortProfile(t *testing.T) {
	...
	resp, err := client.CreateAppPortProfile(t.Context(), types.ParamsCreateEdgeGatewayAppPortProfile{
...
func TestListAppPortProfile(t *testing.T) {
	...
	resp, err := client.ListAppPortProfile(t.Context(), types.ParamsListEdgeGatewayAppPortProfile{EdgeGatewayID: edgeGatewayID})
...
func TestGetAppPortProfileByName(t *testing.T) {
	edgeGatewayID := generator.MustGenerate("{urn:edgegateway}")
	vdcGroupID := generator.MustGenerate("{urn:vdcGroup}")
	vdcGroupName := generator.MustGenerate("{word}")
	profileID := generator.MustGenerate("{urn:applicationPortProfile}")
	...
	resp, err := client.GetAppPortProfile(t.Context(), types.ParamsGetEdgeGatewayAppPortProfile{
		Name:          "app-1",
		EdgeGatewayID: edgeGatewayID,
	})
...
func TestUpdateAppPortProfile(t *testing.T) {
	...
	resp, err := client.UpdateAppPortProfile(t.Context(), types.ParamsUpdateEdgeGatewayAppPortProfile{
		ID:          profileID,
...
func TestDeleteAppPortProfile(t *testing.T) {
	...
	err := client.DeleteAppPortProfile(t.Context(), types.ParamsDeleteEdgeGatewayAppPortProfile{ID: profileID})
